...
This is a workshop for [IRE 2024](https://schedules.ire.org/ire-2024/) about general data cleaning tips. It's taught by me, [Jonathan Soma](https://jonathansoma.com/everything/), Knight Chair in Data Journalism at Columbia Journalism School.

You might also be interested in my series [Practical AI for Investigative Journalism](https://www.youtube.com/playlist?list=PLewNEVDy7gq1_GPUaL0OQ31QsiHP5ncAQ)

# The worksheets

This stuff really only makes sense once you've tried it out, so we have worksheets!

- **Google Sheets**
    - [Blank worksheet](https://docs.google.com/spreadsheets/d/1hnM7Tl_fiwXFzb7nVDlvH6oA8Dj4ecch31kEMrkpQEQ/edit?usp=sharing)
...
##  Text manipulation: Substitute with nothing
...
##  Text manipulation: Convert to a number
...
## Text manipulation: Split and get first (...or second or third)
...
## Text manipulation: Split and get last
...
## Text manipulation: Double split!!!
...
## Text manipulation: Split on many characters
...
## Text manipulation: Get last (or first) *n* characters 
...
## Regex: replace [...] in Google Sheets without a formula
...
## Regex: matches pattern, not replaces
...
## Table formatting: Convert from long to wide
...
## Table formatting: Convert from wide to long
